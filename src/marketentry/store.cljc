(ns marketentry.store
  "SSoT for the Commonwealth of Dominica (DMA) market-entry compliance
...
(defn demo-data
  ...
  `:contract-value` (EC$) / `:confirming-authority` / `:approving-
  authority` are ground truth for the flagship DUAL AUTHORITY-ESCALATION
  check (Public Procurement and Disposal of Public Property Act, 2021
  Second Schedule); `:has-employees?` / `:paye-registered?` are ground
  truth for the conditional employee-PAYE-registration check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Roseau Trading Co. Ltd" :portal "www.dominica.gov.dm/notices"
             :base-fee 450000 :monthly-rate 28000 :monitoring-months 12
             :claimed-fee 786000.0
             :contract-value 750000 :confirming-authority :chief-procurement-compliance-officer :approving-authority :head-of-procuring-entity
             :has-employees? true :paye-registered? true
             :drafted? false :submitted? false
             :jurisdiction "DMA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "www.dominica.gov.dm/notices"
             :base-fee 450000 :monthly-rate 28000 :monitoring-months 12
             :claimed-fee 786000.0
             :contract-value 750000 :confirming-authority :chief-procurement-compliance-officer :approving-authority :head-of-procuring-entity
             :has-employees? true :paye-registered? true
    ...
    "eng-3" {:id "eng-3" :operator "Portsmouth Marine Services Ltd" :portal "www.dominica.gov.dm/notices"
             :base-fee 450000 :monthly-rate 28000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "DMA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Kalinago Territory Agro-Processors Ltd" :portal "www.dominica.gov.dm/notices"
             :base-fee 450000 :monthly-rate 28000 :monitoring-months 12
             :claimed-fee 786000.0
             :contract-value 1500000 :confirming-authority :chief-procurement-compliance-officer :approving-authority :head-of-procuring-entity
             :has-employees? true :paye-registered? true
             :drafted? false :submitted? false
             :jurisdiction "DMA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Layou River Construction Ltd" :portal "www.dominica.gov.dm/notices"
             :base-fee 450000 :monthly-rate 28000 :monitoring-months 12
             :claimed-fee 786000.0
             :contract-value 750000 :confirming-authority :chief-procurement-compliance-officer :approving-authority :head-of-procuring-entity
             :has-employees? true :paye-registered? false
             :drafted? false :submitted? false
             :jurisdiction "DMA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Salybia Community Supplies Ltd" :portal "www.dominica.gov.dm/notices"
             :base-fee 300000 :monthly-rate 20000 :monitoring-months 6
             :claimed-fee 420000.0
             :contract-value 3000 :confirming-authority :head-of-procuring-entity :approving-authority :head-of-procuring-entity
             :has-employees? false :paye-registered? false
             :drafted? false :submitted? false
             :jurisdiction "DMA" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               contract-value confirming-authority approving-authority
                               has-employees? paye-registered?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    confirming-authority                  (assoc :engagement/confirming-authority confirming-authority)
    approving-authority                   (assoc :engagement/approving-authority approving-authority)
    (some? has-employees?)                (assoc :engagement/has-employees? has-employees?)
    (some? paye-registered?)              (assoc :engagement/paye-registered? paye-registered?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/contract-value :engagement/confirming-authority :engagement/approving-authority
   :engagement/has-employees? :engagement/paye-registered?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :confirming-authority (:engagement/confirming-authority m)
     :approving-authority (:engagement/approving-authority m)
     :has-employees? (boolean (:engagement/has-employees? m))
     :paye-registered? (boolean (:engagement/paye-registered? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-dma"})
